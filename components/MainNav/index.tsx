...
const MainNav = () => {
  ...
  return (
    <section className="nt-header mx-auto absolute left-0 right-0">
      <div className="container mx-auto">
        <div className="row">
          <div className="grid-cols-2 nt-top border rounded flex justify-between p-5 mt-5 bg-gray-50">
            ...
            <div className="sam-element flex">
              <div className="sam-main-nav">
                <ul className="flex py-2 mr-8">
                  ...
                  <li className={`/`} onClick={handleLoginModalOpen}>
                    Login
                  </li>
